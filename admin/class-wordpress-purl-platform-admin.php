...
class Wordpress_Purl_Platform_Admin {
    ...
    public function add_plugin_admin_menu() {
        ...
        add_submenu_page( 'wordpress-purl-platform', 'Settings', 'Settings', 'manage_options', 'wordpress-purl-platform', array($this, 'display_plugin_setup_page'));
        add_submenu_page( 'wordpress-purl-platform', 'All Users', 'All Users', 'manage_options', 'wordpress-purl-platform-all', array($this, 'display_plugin_all_users_page'));
        add_submenu_page( 'wordpress-purl-platform', 'Active Users', 'Active Users', 'manage_options', 'wordpress-purl-platform-active', array($this, 'display_plugin_visited_users_page'));
        add_submenu_page( 'wordpress-purl-platform', 'Inactive Users', 'Inactive Users', 'manage_options', 'wordpress-purl-platform-inactive', array($this, 'display_plugin_non_visited_users_page'));
    ...
    /**
     * Render the all Users page for this plugin.
     *
     * @since    0.0.3
     */
    ...
    /**
     * Render the visited Users page for this plugin.
     *
     * @since    0.0.3
     */
    ...
    /**
     * Render the non-visited Users page for this plugin.
     *
     * @since    0.0.3
     */
