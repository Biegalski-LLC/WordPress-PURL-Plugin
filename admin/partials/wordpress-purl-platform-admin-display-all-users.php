...
<?php else:
    ...
    if($total_records === 0):
        ...
        $allResults = $wpdb->get_results("SELECT * from $tableName LIMIT $start, $posts_per_page");
        $total_records = $wpdb->num_rows;
        ?>
        <h2 class="nav-tab-wrapper" style="margin-top:20px;"><?php _e('All PURL Users', $this->plugin_name);?></h2>
        ...
        <table class="table table-striped">
            ...
            <tbody>
            <?php echo $purl->outputPurlUsers($allResults, ''); ?>
            </tbody>
        </table>
