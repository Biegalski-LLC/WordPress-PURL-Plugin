...
<?php else:
    ...
    if($total_records === 0):
        ...
        $visitedResults = $wpdb->get_results("SELECT * from $tableName WHERE visited = '1' LIMIT $start, $posts_per_page");
        $total_records = $wpdb->num_rows;
?>
<div class="wrap">
    <h2 class="nav-tab-wrapper" style="margin-top:20px;"><?php _e('Active PURL Users', $this->plugin_name);?></h2>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                <?php echo $purl->outputPurlUsers($visitedResults, 'Active'); ?>
            </tbody>
        </table>
