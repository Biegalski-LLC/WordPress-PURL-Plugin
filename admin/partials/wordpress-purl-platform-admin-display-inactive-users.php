...
<div class="wrap">
    ...
    <?php else: ?>
        ...
        <?php else: ?>
            <?php $nonVisitedResults = $wpdb->get_results("SELECT * from $tableName WHERE visited = '0'"); ?>

            <h2 class="nav-tab-wrapper" style="margin-top:20px;"><?php _e('Inactive PURL Clients', $this->plugin_name);?></h2>
            <p><?php _e('The table below represents all PURL clients who haven\'t visited their Personalized URL [PURL] landing page.', $this->plugin_name);?></p>
